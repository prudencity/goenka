...
namespace Finance_Management_System //AllocationRequest
{
    ...
    public static class Extensions
    {
            ...
            Graphics g, int pagewidth, int pageheight, Margins margins)
        {
            foreach (T t in list)
            {
                if (t is ClsDGVPrinter.ImbeddedImage)
                {
                    ClsDGVPrinter.ImbeddedImage ii = (ClsDGVPrinter.ImbeddedImage)Convert.ChangeType(t, typeof(ClsDGVPrinter.ImbeddedImage));
