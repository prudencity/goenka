...
{
    public partial class Frm_LoanApplicationReport : Form
    {
        public Frm_LoanApplicationReport()
        {
            InitializeComponent();
        }
        ...
        private void btnExcel_Click(object sender, EventArgs e)
        {
            ...
            clsGeneral.ExcelExport(dg_head, "Loan Application Report From " + dtpStart.Value.ToString("dd/MM/yyyy") + " To " + dtpEnd.Value.ToString("dd/MM/yyyy") + "");
        }
        ...
        private void btnShow_Click(object sender, EventArgs e)
        {
            ...
            string SS = "Select ROW_NUMBER() OVER(ORDER BY FormNo Asc) AS [Sr No],Id,Agent,Office,FormNo As [Application No],Convert(Varchar,FormDate,106) As Date, ";
            SS = SS + " PartyName As [Customer Name],PLoanAmount As [Loan Amount], ";
            SS = SS + " CashCheque As [Cash Cheque],LoanType As [Loan Type],LoanPeriod As [No of EMI],EMI From vw_LoanApplication ";
            ...
            dg_head.Columns["Application No"].Width = 80;
        ...
        private void Frm_LoanApplicationReport_Load(object sender, EventArgs e)
        {
