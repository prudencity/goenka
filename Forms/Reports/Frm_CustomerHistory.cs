...
{
    public partial class Frm_CustomerHistory : Form
    {
        public Frm_CustomerHistory()
        {
            InitializeComponent();
        }
        ...
        public void btnShow_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                int PartyId = txtName.ValueGet("Please Select Customer");
                if (PartyId > 0)
                {
                    ...
                    ColDrAmount.DisplayIndex = 4;
                    ColCrAmount.DisplayIndex = 5;
                    ColBalance.DisplayIndex = 6;
