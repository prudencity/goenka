...
{
    public partial class Frm_AgentPayment : Form
    {
        public Frm_AgentPayment()
        {
            InitializeComponent();
        }
        ...
        private void Frm_CashReceipt_Load(object sender, EventArgs e)
        {
            ...
            string SSdata = "Select AgentId As Id,AgentName As Name From AgentMaster Order by AgentName";
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (CashId > 0)
                {
                    string Data = "Delete from AgentPayment where C_ID =" + CashId;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Insdata = "Insert Into AgentPayment (C_PartyId,C_Date,C_Amount,C_Remarks,C_BankId)";
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            string SSdata = "SELECT '' As SrNo ,AgentPayment.C_ID AS Id,AgentName As Name,  ";
            SSdata = SSdata + " Convert(Varchar, AgentPayment.C_Date,103) As ReceiptDate, ";
            SSdata = SSdata + " CONVERT(VARCHAR, CONVERT(MONEY, AgentPayment.C_Amount), 1) As Amount ";
            SSdata = SSdata + " FROM AgentPayment ";
            SSdata = SSdata + " INNER JOIN AgentMaster ON AgentPayment.C_PartyId = AgentMaster.AgentId ";
            SSdata = SSdata + " Where C_Date >= " + clsGeneral.ComapreDateFormat(dtpStart.Value) + " And C_Date <= " + clsGeneral.ComapreDateFormat(dtpEnd.Value) + " Order By C_Date";
        ...
        public void FillData(int Id)
        {
            try
            {
                string SSddata = "Select * From AgentPayment Where C_Id = " + Id + "";
