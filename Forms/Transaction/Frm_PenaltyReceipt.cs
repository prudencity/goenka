...
{
    public partial class Frm_PenaltyReceipt : Form
    {
        public Frm_PenaltyReceipt()
        {
            InitializeComponent();
        }
        ...
        private void btnDelete_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (CashId > 0)
                {
                    ...
                    string Data = "Delete from CashReceipt where C_ID =" + CashId;
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                string Insdata = "Insert Into CashReceipt (C_PartyId,C_Date,C_Amount,C_Remarks,C_BankId)";
        ...
        private void btnFind_Click(object sender, EventArgs e)
        {
            ...
            string SSdata = "SELECT '' As SrNo ,CashReceipt.C_ID AS Id,P_Name + '-' + Convert(Varchar,L_FormNo) As Name,  ";
            SSdata = SSdata + " Convert(Varchar, CashReceipt.C_Date,103) As ReceiptDate, ";
            SSdata = SSdata + " CONVERT(VARCHAR, CONVERT(MONEY, CashReceipt.C_Amount), 1) As Amount ";
            SSdata = SSdata + " FROM CashReceipt ";
            SSdata = SSdata + " INNER JOIN LoanSanction ON CashReceipt.C_PartyId = LoanSanction.L_Id ";
        ...
        public void FillData(int Id)
        {
            try
            {
                string SSddata = "Select * From CashReceipt Where C_Id = " + Id + "";
